...
<body class="">
  ...
  <div class="container-fluid" style="margin: 2rem auto; padding: 2rem" id="dashboard">
    <div class="row pb-3">
      <div class="col btn-toolbar">
        <h2 class="mr-3" id="span_identificar_listado_actual"></h2>
        <img src="https://img.freepik.com/vector-gratis/flecha-derecha-roja_78370-4688.jpg" width="60" height="40">
        <div class="ml-3" id="div_btn_cambiar_listado"></div>
      </div>
    </div>
  ...
  <div class="container-fluid" style="margin: 2rem auto; padding: 2rem; display: none" id="history">
    <div class="row pt-3 pb-3">
      <div class="col">
        <div class="row pt-3 pb-3">
          <div class="col btn-toolbar">
            <h2 class="mr-3" id="span_identificar_historial_actual"></h2>
            <img src="https://img.freepik.com/vector-gratis/flecha-derecha-roja_78370-4688.jpg" width="60" height="40">
            <div class="ml-3" id="div_btn_cambiar_historial"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid" style="margin: 2rem auto; padding: 2rem; display: none" id="control_abm">
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <div class="form-group">
          <label for="">Titular grupo familiar</label>
          <input type="text" class="form-control abm_input" name="" id="abm_cedula_titular_gf" readonly />
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="">
            ...
            <hr />
            <p class="text-uppercase" style="font-size: 1.8rem">TOTAL: $UY
              <span class="text-muted" style="font-size: 1.6rem" id="total"></span>
            </p>
          </div>
        </div>
        <div class="modal-footer">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            <div class="form-group">
              <p>Ingresar la cuenta de correo electrónico para crear una
                cuenta en VidaShop.</p>
              <p>En caso de no ingresar la misma, se creara una cuenta con el
                email <b>cedula@sinmail.com.uy</b> y la contraseña será la
                <b>cedula</b>.
              </p>
            </div>
            <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mt-3">
            <label for="patologiaCobro" class="texto">Patología *</label>
            <select id="patologiaCobro" class="form-control"></select>
          </div>

          <div class="mt-3">
            <label for="observacionPatologiaCobro" class="texto">Observación patología *</label>
            <textarea class="form-control" id="observacionPatologiaCobro" rows="4" placeholder=""></textarea>
          </div>
        </div>
  ...
  <div class="modal" tabindex="-1" role="dialog" id="modal_registrar_vidaapp">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <span style="color: red; font-size: 12px; padding: 5px">*Para ingresar en VidaApp la persona deberá usar su cédula tanto de
          usuario como de contraseña.</span>
        <div class="modal-body">
          <form>
            <div class="form-group">
            ...
            <div class="form-group mt-3">
              <label for="mail_vidaapp">Email </label><span style="color: red; font-size: 12px">
                (no obligatorio, en caso de no llenarlo la persona no recibirá
                el manual, ni podrá reestablecer su contraseña)</span>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <p class="small">Caracteres disponibles:
                    <span class="text-danger caracteresDisponibles">20</span>
                  </p>
                </div>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-2" style="display: none" id="divPuerta">
                <div class="form-group">
                  ...
                  <p class="small">Caracteres disponibles:
                    <span class="text-danger caracteresDisponibles">4</span>
                  </p>
                </div>
              </div>
  ...
  <script src="js/funciones.js?v=20230710_1"></script>
  <script src="js/index.js?v=20240312_1"></script>
</body>
