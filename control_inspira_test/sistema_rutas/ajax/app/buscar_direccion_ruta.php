...
$query="SELECT CONVERT(CAST(CONVERT(referencia USING latin1) AS BINARY) USING UTF8) AS referencia_utf8, direcciones_socios.*,padron_datos_socio.nombre,
...
$socio_call = query(
    $conexion_call,
    "SELECT CONVERT(CAST(CONVERT(ciudades.nombre USING latin1) AS BINARY) USING UTF8) AS localidad,direccion,ciudades.id_departamento,
