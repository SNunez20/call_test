...
if (isset($_SESSION['idusuario'])) {
    ...
    $q2          = "insert into historico values(null,'$numero','no interesado',$idusuario,'$fecha','$chk')";
    ...
    $q      = "update numeros set flag = 'no interesado' where numero = '$numero'";
            ...
            if ($devuelve > 0) {
                ...
                if ($result5) {
                    ...
                    if ($result6) {
                        ...
                        if ($result7) {
                            $response = array('result' => 'NumeroDespuesNoInteresado', 'numero' => $numero, 'message' => 'Correcto.', 'localidad' => $localidad);
                        }
                    }
                }
            } else {
