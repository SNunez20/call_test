<!DOCTYPE html>
    ...
    <script src="Js/call.js?v=1.1" type="text/javascript"></script>
	...
	<body>
	<header>
	<h1><div class="logotipocall"><img src="img/logocall.png"></div></h1>
	</header>
	...
	<div class="logocall"><img src="img/logocall.png"></div>
		<div class="content">
			<table width="auto" border="0">
				<tbody>
					<tr>
						...
						<td style="text-align:left;"> <input maxlength="8" name="usuario" type="text" class="hvr-border-fade" placeholder="Nombre de Usuario" id="usuario" style="width:250px" ></td>
					</tr>
					<tr>
						<td style="text-align:left; "><span class="iconoslogin"><img src="img/contrasena.png"/></span></td>
						<td style="text-align:left;"><input maxlength="8" name="contrasena" type="password" class="hvr-border-fade" placeholder="Contraseña" id="contrasena" style="width:250px"/></td>
					</tr>
				</tbody>
			</table>		
			<br>
			...
			<div class="footer">
				<input type="button" name="btnEntrar" value="Ingresar" class="hvr-border-fadebtn" id="btnEntrar" onclick="login()"/>
			</div>
		</div>
     </form>
	</body>
