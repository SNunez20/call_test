 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Histórico de altas</h1>         
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">Historico altas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12 col-lg-6">
              ...
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Filtrar por fechas</h1>
              </div>
              <div class="row mb-3">
                  <div class="col-md-12">
                      <div class="card border-left-primary shadow h-90 py-2">
                          <div class="card-body">
                              ...
                              <form class="form-inline" action="">
                                  ...
                                  <button type="button" id="btnReporteHistoricoAltas" onClick="historicoAltas()" class="btn btn-primary"><i class="fas fa-search"></i></button>
                              </form> 
                          </div>
                      </div>
                  </div>
        ...
        <div class="row">  
          <section class="col-lg-12">    
            <div class="card tablaReporte">
              ...
              <div class="card-body">
                <table id="tableHistoricoAltas" class="table table-striped table-bordered table-sm text-center" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th class="th-sm">Filial
                      </th>
                      <th class="th-sm">Mes 1
                      </th>
                      <th class="th-sm">Mes 2
                      </th>
                      <th class="th-sm">Mes 3
                      </th>
                      <th class="th-sm">Mes 4 
                      </th>
                      <th class="th-sm">Mes 5
                      </th>
                      <th class="th-sm">Mes 6
                      </th>
                    </tr>
                  </thead>
