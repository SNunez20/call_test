...
$ayer2 = date('d/m/Y',strtotime("-1 days"));
...
$q = "select * from jugadores_referidos where cast(fecha as date) = '$ayer' and telefono_jugador like '09%'";
...
mysqli_close($mysqli);
    ...
    $sBody = '<html xmlns="https://www.w3.org/1999/xhtml">
            ...
            <body>
                <h1>Informe Referidos El Desafio ('.$ayer2.')</h2>
