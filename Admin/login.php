<!DOCTYPE html>
    ...
    <script src="Js/admincall.js?v=1.1" type="text/javascript"></script>
	...
	<h1><div class="logotipocall"><img src="../img/logocall.png">	<span style="top:10px; margin-left:50px;"> Administradores </span></div></h1>
	</header>
...
<div class="imagenlogin"></div>
		<div class="content">
			<table width="100%" border="0">
				<tbody>
					<tr>
						<td style="text-align:right;"><span class="iconoslogin"><img src="../img/usuario2.png"></span></td>
			...
			<div class="footer">
				<input type="button" name="btnEntrar" value="Ingresar" class="hvr-border-fadebtn" id="btnEntrar" onclick="loginAdmin()"/>
			</div>
		</div>
     </form>
	</body>