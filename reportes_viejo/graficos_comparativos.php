 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Gráficos comparativos</h1>         
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">Gráficos comparativos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                      ...
                      <div class="card border-left-primary shadow h-90 py-2">
                          <div class="card-body">
                              ...
                              <form class="form-inline" action="">
                                  ...
                                  <button type="button" id="btnReporteHistoricoAltas" onClick="mostrarGraficos()" class="btn btn-primary"><i class="fas fa-search"></i></button>
                              </form> 
                          </div>
                      </div>
                  </div>
        ...
        <div class="row">  
          <section class="col-lg-12">    
            <div class="card tablaReporte">
              ...
              <div class="card-body">
              <div class="chart">
                  <canvas id="barChart" style="min-height: 300px; height: 300px; max-height: 500px; max-width: 100%;"></canvas>
                </div>
              </div>
