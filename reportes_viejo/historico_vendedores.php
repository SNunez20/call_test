 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Histórico vendedores</h1>         
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">Historico vendedores</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12 col-lg-8">
              ...
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Buscar vendedor</h1>
              </div>
              <div class="row mb-3">
                  <div class="col-md-12">
                          ...
                          <div class="card-body">
                              ...
                              <form class="form-inline" action="">
                                  <div class="form-group ml-2">                                
                                    <label for="cedula_vendedor" class="control-label mr-2">Cédula: </label>
                                    <input type="text" id="cedula_vendedor" class="mr-2 enter_and_submit fecha form-control bg-light small solo_numeros" placeholder="Cedula vendedor" aria-label="Buscar" aria-describedby="basic-addon2">                          
                                  </div>
                                  <div class="form-group ml-2">                                
                                  ...
                                  <button type="button" id="btnReporteHistoricoVendedor" onClick="historicoVendedores()" class="btn btn-primary"><i class="fas fa-search"></i></button>
                              </form> 
                          </div>
                      </div>
                  </div>
        ...
        <div class="row">  
          <section class="col-lg-12">    
            <div class="card tablaReporte">
              ...
              <div class="card-body">
                <table id="tableHistoricoVendedor" class="table table-striped table-bordered table-sm text-center" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th class="th-sm">Socio
                      </th>
                      <th class="th-sm">cedula socio
                      </th>
                      <th class="th-sm">Tipo afiliación
                      </th>
                      <th class="th-sm">Monto venta
                      </th>
                      <th class="th-sm">Fecha venta
                      </th>
                    </tr>
                  </thead>
